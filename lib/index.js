...
internals.schema = Joi.object({
  ...
  scope: Joi.alternatives(Joi.array().items(Joi.string()), Joi.func()).when('provider.protocol', {
    is: 'oauth2',
  ...
  location: Joi.alternatives(Joi.func().maxArity(1), Joi.string()).default(false),
