...
exports.v1 = function (settings) {
  ...
  return async function (request, h) {
    ...
    if (client.settings.clientFunction) {
      console.log('0client.settings', client.settings)
      client.settings.clientFunction(request, client.settings)
      console.log('1client.settings', client.settings)
    }
